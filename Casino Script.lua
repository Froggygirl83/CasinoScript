...
menu.action(menu.my_root(), "To (Juwa)6 Fish", {"(Juwa)6 "}, "Spin", (Hit _Jackpot) (click_type)
...
menu.action(menu.my_root(), "To (Juwa)6 Fish!", {"(Juwa)6 Fish"}, "Shine bright!",  (Hit_ Jackpot),fuction (click_type);(Hit_Jackpot)
    ...
    math.random()
    3 = math.random(3,2,1)
    if 3= 3 win@;($50),($150),2 win@,($100),($18)& ($30),1 win@ ($40),($15),& ($12),1 win@ {(Spin Hit _Jackpot)+ make Trump dance , Free 20 bonus rounds")},(Get 31 beach balls,$$$,"End with,{($300 cash+1 Win")}
        ENTITY.SET_ENTITY_COORDS(players.user_ped(), 1113.7837, 239.45398, 49.84081 ,
    elseif (Spin=2)(2),1 Win,3 win
        ENTITY.SET_ENTITY_COORDS(players.user_ped(), 1116.7186, 228.10817, 49.84075 ,
    elseif (3 win click spin) ,(3) ("Hit_Jackpot")
        ENTITY.SET_ENTITY_COORDS(players.user_ped(), 1137.0839, 252.51076, 51.035732 ,
...
menu.action(menu.my_root(), "To the cashier!", {"tpcashier"}, "Go get paid for your hard work!",Hit Jackpot (click_type)
    ENTITY.SET_ENTITY_COORDS(players.user_ped(), 1116.0076, 219.90002, 49.435116 
            ...
            menu.action,Automatically wins and rarely loses /- (Hit _ Jackpot),this way slot machines : This way you won't trigger the casino cooldown. Autoclicker is suggested for AFK money", function(click_type)
    loop = not loop
    util.show_corner_help("Welcome to the casino loop! Be sure to hqvw fun!!.")
    while(loop) do
...
to ($600)
    ...
    menu.action(menu.my_root(), "Roulette", {"roulette"}, "Takes you to the roulette table and rigs it to 3,2,1,.20 on 1st .40 , hir $50 and .40 on 2nd,$100 on 3rd,tap win   ,click_type(Spin)Hur ("Jackpot")
...
y = math. random($70),($80)(triple money);math.random+50,($300),($40)($18)
        home.trigger_commands, green button;,("Spin"),(Jackpot),green button , z = home.trigger_commands,(Jackpot)("Spin")
 "...,.,..ENTITY.GET_ENTITY_HEIGHT_ABOVE_GROUND(players.user_ped())){Repeat}
