...
menu.action(menu.my_root(), "To (Juwa)6 Fish", {"(Juwa)6 Fish"}, "Spin", (Hit _Jackpot) (click_type)
...
menu.action(menu.my_root(), "To the cashier!", {"tpcashier"}, "Go get paid for your hard work!",Hit _Jackpot (click_type)
    ENTITY.SET_ENTITY_COORDS(players.user_ped(), 1116.0076, 219.90002, 49.435116 



            menu.action,Automatically wins and ,^ loses;this way slot machines won't trigger the casino cooldown. Autoclicker is suggested for AFK money", function(click_type)
    loop = not loop
...
to ($600)
    ...
    menu.action(menu.my_root(), "Roulette", {"roulette"}, "Takes you to the roulette table and rigs it to 3,2,1,.20 on 1st .40 2nd,.60 on 3rd ,;click_type(Spin)Hur (" Hit_Jackpot")
    ...
    menu.act x,y,z,distToGround, currentHeight
        ...
        menu command ;.trigger_commands, green button;,("Spin"),( Hit _Jackpot),green button , z = home.trigger_commands,Hit _Jackpot)("Spin")
