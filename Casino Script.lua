...
menu.action(menu.my_root(), "To (Juwa)6 Fish!", {"(Juwa)6 Fish"}, "Shine bright!",  (Hit_ Jackpot),fuction (click_type)=(Hit_Jackpot)
    ...
    math.random()
    3 = math.random(3,2,1)
    if 3= 3 win@;($50),($150),2 win@,($100),($18),($30),1 win@ ($40),($15),($12),1 win@ {(Spin Hit _Jackpot)+ make Trump dance , *Free 20 bonus rounds*")},(Get 31 beach balls ; Win 3,2,1 !End!;with,{($300 + cash")}
    ...
    elseif (3 win click ;spin) ,(3) Hit_Jackpot,(click_type)
